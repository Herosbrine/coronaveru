...
void initialize_data(data_t *data)
{
    ...
    initialize_intro(data);
}

void initialize_intro(data_t *data)
{
    data->textures.tinto1 = sfTexture_createFromFile("text/la_pefra.png", NULL);
    data->textures.tinto2 = sfTexture_createFromFile("text/present.png", NULL);
    data->textures.tinto3 = sfTexture_createFromFile("text/coronave_logo.png", NULL);
    data->intro.sintro1 = sfSprite_create();
    data->intro.sintro2 = sfSprite_create();
    data->intro.sintro3 = sfSprite_create();
    sfSprite_setTexture(data->intro.sintro1, data->textures.tinto1, 0);
    sfSprite_setTexture(data->intro.sintro2, data->textures.tinto2, 0);
    sfSprite_setTexture(data->intro.sintro3, data->textures.tinto3, 0);
}

void initialize_text1(data_t *data)
{
    data->textures.ttext1a = sfTexture_createFromFile("text/text1/text1_opacity_20.png", NULL);
    data->textures.ttext1b = sfTexture_createFromFile("text/text1/text1_opacity_40.png", NULL);
    data->textures.ttext1c = sfTexture_createFromFile("text/text1/text1_opacity_60.png", NULL);
    data->textures.ttext1d = sfTexture_createFromFile("text/text1/text1_opacity_80.png", NULL);
    data->textures.ttext1e = sfTexture_createFromFile("text/text1/text1_opacity_100.png", NULL);
...
{
    data->textures.ttext2a = sfTexture_createFromFile("text/text2/text2_opacity_20.png", NULL);
    data->textures.ttext2b = sfTexture_createFromFile("text/text2/text2_opacity_40.png", NULL);
    data->textures.ttext2c = sfTexture_createFromFile("text/text2/text2_opacity_60.png", NULL);
    data->textures.ttext2d = sfTexture_createFromFile("text/text2/text2_opacity_80.png", NULL);
    data->textures.ttext2e = sfTexture_createFromFile("text/text2/text2_opacity_100.png", NULL);
...
{
    data->textures.ttext3a = sfTexture_createFromFile("text/text3/text3_opacity_20.png", NULL);
    data->textures.ttext3b = sfTexture_createFromFile("text/text3/text3_opacity_40.png", NULL);
    data->textures.ttext3c = sfTexture_createFromFile("text/text3/text3_opacity_60.png", NULL);
    data->textures.ttext3d = sfTexture_createFromFile("text/text3/text3_opacity_80.png", NULL);
    data->textures.ttext3e = sfTexture_createFromFile("text/text3/text3_opacity_100.png", NULL);
...
{
    data->textures.ttext4a = sfTexture_createFromFile("text/text4/text4_opacity_20.png", NULL);
    data->textures.ttext4b = sfTexture_createFromFile("text/text4/text4_opacity_40.png", NULL);
    data->textures.ttext4c = sfTexture_createFromFile("text/text4/text4_opacity_60.png", NULL);
    data->textures.ttext4d = sfTexture_createFromFile("text/text4/text4_opacity_80.png", NULL);
    data->textures.ttext4e = sfTexture_createFromFile("text/text4/text4_opacity_100.png", NULL);
